    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li id="register" runat="server"><a class="navbar-brand" href="Register.aspx"><i class="fa fa-book fa-lg"></i>Register</a></li>
                <li id="login" runat="server"><a class="navbar-brand" href="Login.aspx"><i class="fa fa-puzzle-piece fa-lg"></i>Login</a></li>
                <li id="about" runat="server"><a class="navbar-brand" href="About.aspx"><i class="fa fa-phone fa-lg"></i> About</a></li>
